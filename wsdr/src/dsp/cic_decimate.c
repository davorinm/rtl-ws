...
int cic_decimate(int R, const cmplx_s32 *src, int src_len, cmplx_s32 *dst, int dst_len, struct cic_delay_line *delay)
{
    ...
    for (src_idx = 0; src_idx < src_len; src_idx++)
    {
        ...
        set_cmplx_s32(integrator_curr_in, src[src_idx]);
