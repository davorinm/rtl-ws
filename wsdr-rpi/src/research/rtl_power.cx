...
static double bartlett(int i, int length)
{
	double N1, L, w;
	L = (double)length;
	N1 = L - 1;
...
static void rms_power(struct tuning_state *ts)
...
static void frequency_range(char *arg, double crop)
...
static void fifth_order(int16_t *data, int length)
...
static void generic_fir(int16_t *data, int length, int *fir)
